...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 32
    payoff_R1 = [600,  600,  600,  600,  600,  600,  600,  600,  600, 600,  600, 850, 850, 600, 600, 600]
    payoff_R2 = [600,  600,  600,  600,  600,  600,  600,  600,  600, 600,  850, 600, 850, 600, 600, 600]
    payoff_S1 = [180,  180,  180,  180,  180,  180,  180,  180,  20,  20,   180, 180, 180, 180, 20,  20 ]
    payoff_T2 = [1000,1000, 1000, 1000, 1000, 1000, 1000,  700, 1000, 700, 1000, 1000,1000,700,1000, 700]

    payoff_T1 = [1000,1000, 1000, 1000,  700, 1000, 700,  1000, 1000, 1000,1000, 1000,1000,700,1000, 700]
    payoff_S2 = [180,  180,  180,  180,  180,  20,   20,  180,  180,  180, 180,  180, 180, 180, 20,  20]
    payoff_D1 = [200,  200,  580,  580,  200,  200, 200,   200,  200, 200,  200,  200, 200,200, 200, 200]
    payoff_D2 = [200,  580,  200,  580,  200,  200, 200,   200,  200, 200,  200,  200, 200,200, 200, 200]
