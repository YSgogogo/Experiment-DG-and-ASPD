...
def creating_session(subsession: Subsession):
    if subsession.round_number == 1:
        ...
        for g in subsession.get_groups():
            ...
            g.in_round(9).selected_task_be = random_task
            for p in g.get_players():
                p.in_round(9).selected_task_be = g.in_round(9).selected_task_be

            for i in range(1, C.NUM_ROUNDS + 1):
                if g.in_round(i).task_number == g.in_round(9).selected_task_be:
                    g.in_round(9).selected_round_be = i
                    break
...
class ResultsWaitPage(WaitPage):
    ...
    def after_all_players_arrive(group: Group):
        ...
        player_1_in_selected_round_be = player_1.in_round(selected_round_be)
        player_2_in_selected_round_be = player_2.in_round(selected_round_be)
        ...
        player_1.participant.vars[__name__] = [str(player_1.payoff), 'First mover', str(selected_round), str(player_2_in_selected_round_be.choice_1st), str(player_2_in_selected_round_be.choice_2nd_Top), str(player_2_in_selected_round_be.choice_2nd_Down), str(selected_task)]
        player_2.participant.vars[__name__] = [str(player_2.payoff), 'Second mover', str(selected_round), str(player_1_in_selected_round_be.choice_1st), str(player_1_in_selected_round_be.choice_2nd_Top), str(player_1_in_selected_round_be.choice_2nd_Down), str(selected_task)]
