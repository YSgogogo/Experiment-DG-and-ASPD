...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 18
    payoff_R1 = [800, 800, 800, 800, 800, 800, 800, 800, 800]
    payoff_S1 = [420, 420, 420, 420, 420, 420, 420, 420, 420]
    payoff_T1 = [1000, 1000, 1000, 1000, 810, 810, 810, 1000, 1000]
    payoff_D1 = [780, 780, 780, 780, 780, 430, 780, 430, 430]
    payoff_R2 = [550, 550, 550, 550, 550, 550, 550, 550, 550,]
    payoff_S2 = [250, 250, 50, 50, 50, 50, 50, 50, 250]
    payoff_T2 = [850, 850, 850, 850, 850, 850, 850, 850, 850]
    payoff_D2 = [260, 520, 260, 520, 520, 260, 260, 260, 260]
