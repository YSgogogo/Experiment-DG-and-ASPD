...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 32
    payoff_R1 = [650,  850,  850,  850,  650,  650,  650,  650,  650, 650,  650, 850, 850, 650, 650, 650]
    payoff_R2 = [650,  850,  850,  850,  650,  650,  650,  650,  650, 650,  850, 650, 850, 650, 650, 650]
    payoff_S1 = [250,  250,  250,  250,  250,  250,  250,  250,  10,  10,   250, 250, 250, 250, 10,  10 ]
    payoff_T2 = [1000,1000, 1000, 1000, 1000, 1000, 1000,  750, 1000, 750, 1000, 1000,1000,750,1000, 750]

    payoff_T1 = [1000,1000, 1000, 1000,  750, 1000, 750,  1000, 1000, 1000,1000, 1000,1000,750,1000, 750]
    payoff_S2 = [250,  250,  250,  250,  250,   10,  10,   250,  250, 250,  250,  250, 250,250,  10, 10 ]
    payoff_D1 = [300,  300,  800,  800,  300,  300, 300,   300,  300, 300,  300,  300, 300,300, 300, 300]
    payoff_D2 = [300,  800,  300,  800,  300,  300, 300,   300,  300, 300,  300,  300, 300,300, 300, 300]
