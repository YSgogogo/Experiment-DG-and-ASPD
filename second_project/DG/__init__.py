...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 14
    payoff_L1 = [650, 650, 650, 650, 850, 650, 850, 250, 250, 250, 250,  250, 10,  10]
    payoff_L2 = [650, 650, 650, 650, 650, 850, 850, 1000,1000,1000,1000, 750, 1000,750]
    payoff_R1 = [1000,750, 1000,750, 1000,1000,1000,300, 800, 300, 800,  300, 300, 300]
    payoff_R2 = [250, 250, 10,  10,  250, 250 ,250, 300, 300, 800, 800,  300, 300, 300]
