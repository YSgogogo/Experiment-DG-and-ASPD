...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 14
    payoff_L1 = [600, 600, 600, 600, 850, 600, 850, 180, 180, 180, 180,  180, 20,  20]
    payoff_L2 = [600, 600, 600, 600, 600, 850, 850, 1000,1000,1000,1000, 700, 1000,700]
    payoff_R1 = [1000,700, 1000,700, 1000,1000,1000,200, 580, 200, 580,  200, 200, 200]
    payoff_R2 = [180, 180, 20,  20,  180, 180 ,180, 200, 200, 580, 580,  200, 200, 200]
